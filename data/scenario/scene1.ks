...
[jump  storage="scene1.ks"  target="*habu1"  cond="f.at==1"  ]
[jump  storage="scene1.ks"  target="*habu2"  cond="f.at==2"  ]
[jump  storage="scene1.ks"  target="*habu3"  cond="f.at==3"  ]
*habu1
...
[jump  storage="scene1.ks"  target="*jo1"  cond="f.kai==1"  ]
[jump  storage="scene1.ks"  target="*chu1"  cond="f.kai==2"  ]
[jump  storage="scene1.ks"  target="*ge1"  cond="f.kai==3"  ]
*jo1

[button  storage="scene1.ks"  target="*kai1"  graphic="ハブ拳/tap01.png"  width="315"  height="170"  x="156"  y="700"  ]
[wait  time="700"  ]
[jump  storage="scene1.ks"  target="*loop1"  ]
*chu1
...
[tb_eval  exp="f.kai=Math.floor(Math.random()*(3-1+1)+1)"  name="kai"  cmd="="  op="r"  val="1"  val_2="3"  ]
[jump  storage="scene1.ks"  target="*jo2"  cond="f.kai==1"  ]
[jump  storage="scene1.ks"  target="*chu2"  cond="f.kai==2"  ]
[jump  storage="scene1.ks"  target="*ge2"  cond="f.kai==3"  ]
*jo2

[button  storage="badend.ks"  target="*miss"  graphic="ハブ拳/tap01.png"  width="315"  height="170"  x="156"  y="700"  ]
[wait  time="700"  ]
[jump  storage="scene1.ks"  target="*loop2"  ]
*chu2

[button  storage="scene1.ks"  target="*kai2"  graphic="ハブ拳/tap02.png"  width="315"  height="170"  x="156"  y="700"  ]
[wait  time="700"  ]
[jump  storage="scene1.ks"  target="*loop2"  ]
*ge2
...
[tb_eval  exp="f.kai=Math.floor(Math.random()*(3-1+1)+1)"  name="kai"  cmd="="  op="r"  val="1"  val_2="3"  ]
[jump  storage="scene1.ks"  target="*jo3"  cond="f.kai==1"  ]
[jump  storage="scene1.ks"  target="*chu3"  cond="f.kai==2"  ]
[jump  storage="scene1.ks"  target="*ge3"  cond="f.kai==3"  ]
*jo3

[button  storage="badend.ks"  target="*miss"  graphic="ハブ拳/tap01.png"  width="315"  height="170"  x="156"  y="700"  ]
[wait  time="700"  ]
[jump  storage="scene1.ks"  target="*loop3"  ]
*chu3
...
[button  storage="scene1.ks"  target="*kai3"  graphic="ハブ拳/tap03.png"  width="315"  height="170"  x="156"  y="700"  ]
[wait  time="700"  ]
[jump  storage="scene1.ks"  target="*loop3"  ]
*kai1
