...
[tb_eval  exp="f.at=0"  name="at"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[tb_eval  exp="f.kai=0"  name="kai"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[s  ]
*opning

[bg  time="0"  method="crossfade"  storage="ハブ拳/back-beju.png"  ]
[playbgm  volume="100"  time="1000"  loop="true"  storage="ハブ拳/opning.mp3"  ]
[tb_image_show  time="2000"  storage="/default/ハブ拳/opning.png"  name="img_10"  ]
[wait  time="2000"  ]
...
[glink  color="black"  storage="scene1.ks"  size="30"  text="ハブ拳始め！！"  x="155"  y="780"  width=""  height=""  _clickable_img=""  target="*stage1"  ]
[s  ]
*stage1
