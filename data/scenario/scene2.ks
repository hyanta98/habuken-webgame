...
[glink  color="black"  storage="scene2.ks"  size="30"  text="スピードアップじゃ！！"  x="93"  y="780"  width=""  height=""  _clickable_img=""  target="*start"  ]
[s  ]
*start
...
[jump  storage="scene2.ks"  target="*habu1-01"  cond="f.at==1"  ]
[jump  storage="scene2.ks"  target="*habu1-02"  cond="f.at==2"  ]
[jump  storage="scene2.ks"  target="*habu1-03"  cond="f.at==3"  ]
*habu1-01
...
[jump  storage="scene2.ks"  target="*jo1-01"  cond="f.kai==1"  ]
[jump  storage="scene2.ks"  target="*chu1-01"  cond="f.kai==2"  ]
[jump  storage="scene2.ks"  target="*ge1-01"  cond="f.kai==3"  ]
*jo1-01

[button  storage="scene2.ks"  target="*kai1-01"  graphic="ハブ拳/tap01.png"  width="315"  height="170"  x="156"  y="700"  _clickable_img=""  name="img_39"  ]
[wait  time="500"  ]
[jump  storage="scene2.ks"  target="*loop1-01"  ]
*chu1-01
...
[tb_eval  exp="f.kai=Math.floor(Math.random()*(3-1+1)+1)"  name="kai"  cmd="="  op="r"  val="1"  val_2="3"  ]
[jump  storage="scene2.ks"  target="*jo1-02"  cond="f.kai==1"  ]
[jump  storage="scene2.ks"  target="*chu1-02"  cond="f.kai==2"  ]
[jump  storage="scene2.ks"  target="*ge1-02"  cond="f.kai==3"  ]
*jo1-02

[button  storage="badend.ks"  target="*miss"  graphic="ハブ拳/tap01.png"  width="315"  height="170"  x="156"  y="700"  _clickable_img=""  name="img_63"  ]
[wait  time="500"  ]
[jump  storage="scene2.ks"  target="*loop1-02"  ]
*chu1-02

[button  storage="scene2.ks"  target="*kai1-02"  graphic="ハブ拳/tap02.png"  width="315"  height="170"  x="156"  y="700"  _clickable_img=""  name="img_67"  ]
[wait  time="500"  ]
[jump  storage="scene2.ks"  target="*loop1-02"  ]
*ge1-02
...
[tb_eval  exp="f.kai=Math.floor(Math.random()*(3-1+1)+1)"  name="kai"  cmd="="  op="r"  val="1"  val_2="3"  ]
[jump  storage="scene2.ks"  target="*jo1-03"  cond="f.kai==1"  ]
[jump  storage="scene2.ks"  target="*chu1-03"  cond="f.kai==2"  ]
[jump  storage="scene2.ks"  target="*ge1-03"  cond="f.kai==3"  ]
*jo1-03

[button  storage="badend.ks"  target="*miss"  graphic="ハブ拳/tap01.png"  width="315"  height="170"  x="156"  y="700"  _clickable_img=""  name="img_87"  ]
[wait  time="500"  ]
[jump  storage="scene2.ks"  target="*loop1-03"  ]
*chu1-03
...
[button  storage="scene2.ks"  target="*kai1-03"  graphic="ハブ拳/tap03.png"  width="315"  height="170"  x="156"  y="700"  _clickable_img=""  name="img_95"  ]
[wait  time="500"  ]
[jump  storage="scene2.ks"  target="*loop1-03"  ]
[s  ]
*kai1-01
